                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="username" value="<%=session.getAttribute("uname") %>" disabled>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">First Name</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="fname" value="<%=session.getAttribute("fname") %>" disabled>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">Last Name</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="lname" value="<%=session.getAttribute("lname") %>" disabled>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="example-email-input" class="col-sm-2 col-form-label">Email</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="email" name="email" value="<%=session.getAttribute("email") %>" disabled>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="example-tel-input" class="col-sm-2 col-form-label">Mobile No.</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="tel" name="mobile" value="<%=session.getAttribute("mobile") %>" disabled>
                                                </div>
                                            </div>
                                        </div>
